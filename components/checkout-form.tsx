      ...
      <div>
        ...
        <div className="relative">
          ...
          <Input
            ...
            className={`mt-1.5 h-12 pl-10 text-base bg-white/5 border-white/20 text-white placeholder:text-slate-500 focus:border-[#8B5CF6] rounded-lg ${errors.whatsapp ? "border-red-400/70 focus:border-red-400" : ""}`}
          />
        </div>
        {errors.whatsapp ? (
          <p id="checkout-whatsapp-error" className="text-red-400/80 text-sm mt-1">
            {errors.whatsapp}
          </p>
        ) : (
          <p id="checkout-whatsapp-help" className="text-slate-500 text-sm mt-1">
            Usaremos este número para combinar lista, frete e envio do pedido.
          </p>
        )}
      </div>
