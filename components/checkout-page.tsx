...
export function CheckoutPage({
  ...
  useEffect(() => {
    ...
    const loginDraft = readCheckoutLoginDraft(window.sessionStorage)
    if (loginDraft) {
      restoredShippingServiceIdRef.current = loginDraft.shippingServiceId
      setCheckout(loginDraft.checkout)
      return
    }
