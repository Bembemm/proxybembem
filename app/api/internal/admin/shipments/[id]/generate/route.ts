...
import { generateAdminShipment } from "../../../../../../../lib/server/shipment-service.ts"
...
export async function POST(
  ...
  let result: Awaited<ReturnType<typeof generateAdminShipment>>
  try {
    result = await generateAdminShipment({
      shipmentId,
